  ...
  useEffect(() => {
    const fetchCourses = async () => {
      ...
      try {
        ...
        let url = `http://127.0.0.1:8000/courses/?skip=${skip}&limit=${itemsPerPage}`;
        if (searchTerm) {
        ...
        setError("Failed to load courses. Make sure the API server is running.");
        setLoading(false);
        console.error(err);
      }
    };
  ...
  return (
    <div className="container mx-auto p-4">
      <header className="mb-8">
        <h1 className="text-3xl font-bold mb-2">iWannaGraduate</h1>
        <p className="text-gray-600">Search and explore GMU courses</p>
      </header>
