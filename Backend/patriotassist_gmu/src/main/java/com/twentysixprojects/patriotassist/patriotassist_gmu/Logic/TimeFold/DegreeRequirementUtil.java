...
public class DegreeRequirementUtil {

    /**
     * Reads the degree requirements JSON file and collects all course codes (e.g. "CS 110")
    ...
    private static void collectCourseCodes(Object node, Set<String> requiredCourseCodes) {
        if (node instanceof Map) {
            ...
            // If this node represents a course and hasn't been completed:
    ...
    // New method to calculate the LabOnly mapping.
